...
class RegistrationForm(FlaskForm):
    ...
    country = SelectField(_("Country"), choices = choices, validators=[DataRequired()])
    email = StringField(_('Email'), validators=[DataRequired(), Email()])
    organisation = StringField(_('Company/Institution'), validators=[DataRequired()])
    newsletter = BooleanField(_("Subscribe to the newsletter?"))
    str = _("I allow the support team of carculator to collect and store the submitted data. " \
